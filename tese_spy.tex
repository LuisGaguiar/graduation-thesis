...
\examiner{Prof. Dr.}{Rubens Junqueira Magalh\~aes}{Presidente}{ITA}
\examiner{Prof$^\textnormal{a}$. Dr$^\textnormal{a}$.}{Ana Carolina Lorena}{Internal Member}{ITA}
...
\chapter{Methodology}
\label{chap:method}
\input{Chapter5/methodology}

\chapter{Learning Kick Behaviors}
\label{chap:contributions}
\input{Chapter6/contributions}
...
\FRDitapalavraapresentacao{ITA, S\~ao Jos\'e dos Campos. Curso de Gradua\c c\~ao em Engenharia Eletr\^onica. \'area de Ci\^encia da Computa\c c\~ao. Orientador: Prof.~Dr. Takashi Yoneyama. Coorientador: Prof.~Dr. Marcos Ricardo Omena de A. M\'aximo. Defesa em 29/06/2018. }
